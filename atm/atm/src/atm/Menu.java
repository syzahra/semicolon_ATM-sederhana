...
import function.Haji;
import function.Junior;
import function.JenisTabungan;
/**
 *
 * @author ASUS
 */
public class Menu extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Saldo anda saat ini : " + (saldo + masukan));
        hasil = saldo + masukan;
        saldo = hasil;
        jawaban = String.format(" %./2f ", saldo);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String norek = JOptionPane.showInputDialog("Silahkan Masukkan No Rek yang dituju : ");
        masukan = Integer.parseInt(JOptionPane.showInputDialog("Masukkan saldo : "));
        if(saldo <= masukan) {
