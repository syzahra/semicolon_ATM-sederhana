 ...
 * @author ASUS
 */
public class MenuHaji extends javax.swing.JFrame {
    String jawaban;
    int masukan;
    ...
    JenisTabungan haji = new Haji();

    //info rekening
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        jawaban = String.format(" %,.2f ", haji.getSaldo());
